    ...
    return (
        <div>
             <Card>
                ...
                <div className="flex items-center justify-center gap-3 text-gray-700 dark:text-gray-400 mt-1 text-lg">
...
<div>
    <div className='text-center text-gray-700 dark:text-gray-400 text-md space-y-2'>
